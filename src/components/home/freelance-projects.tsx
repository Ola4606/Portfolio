...
import boxingImage from "../../images/bitmojies/boxing.png";
import Button from "../general/button";
import { FreelanceProjectsData } from "../../data/projectsData";
import ProjectTile from "./projectTile";

function FreelanceProjects() {
  const projectsElements = useMemo(() => {
    return FreelanceProjectsData.map((i: any) => {
      return (
        <div key={i.projectID}>
          <ProjectTile
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${boxingImage})` }}
    >
          ...
          <div className=" flex flex-col justify-center items-center">
            <div className="min-h-[200px] xsm:max-w-[350px] sm:max-w-[450px] md:max-w-[500px] lg:max-w-[650px] xl:max-w-[750px]">
              ...
              <p className="font-sans text-xl sm:text-2xl md:text-3xl lg:text-5xl font-bold text-center text-black">
                Here are some of the amazing websites I have created for others.
              </p>
            </div>
